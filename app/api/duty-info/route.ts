...
export async function GET() {
    const res = await fetch(`https://raw.githubusercontent.com/${process.env.GITHUB_OWNER}/${process.env.GITHUB_REPO_DATA}/main/duty-info.json`, {
        cache: "no-store",
    });
...
const BASE_URL = `https://api.github.com/repos/${GITHUB_OWNER}/${GITHUB_REPO_DATA}/contents/duty-info.json`;
